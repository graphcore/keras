...
class TestDeferredSequential(keras_parameterized.TestCase):
  ...
  def test_saving_savedmodel(self):
    ...
    model_layers = model._flatten_layers(include_self=True, recursive=False)  # pylint:disable=protected-access
    new_model_layers = new_model._flatten_layers(  # pylint:disable=protected-access
