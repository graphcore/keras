...
class TestOutputLossMetrics(keras_parameterized.TestCase):
  ...
  def setUp(self):
    ...
    self.sample_weight_1 = np.asarray([2., 3., 4., 5., 6., 7.])
    self.sample_weight_2 = np.asarray([3.5, 2.5, 1.5, 0.5, 3., 2.])

    # y_true_1 = [[2.], [4.], [6.], [8.], [10.], [12.]]
    # y_pred_1 = [[3.], [6.], [9.], [12.], [15.], [18.]]
    # y_true_2 = [[1.], [2.], [3.], [4.], [5.], [6.]]
    # y_pred_2 = [[3.], [6.], [9.], [12.], [15.], [18.]]

    # Loss `output_1`:
    #   Per-sample weighted losses
    #   Batch 1 = [(3 - 2)^2 * 2, (6 - 4)^2 * 3)] = [2, 12]
    #   Batch 2 = [((9 - 6)^2 * 4, (12 - 8)^2 * 5)] = [36, 80]
    #   Batch 3 = [(15 - 10)^2 * 6, (18 - 12)^2 * 7] = [150, 252]

    #   Result (reduction=SUM) =
    #     ((2 + 12)*2 + (36 + 80)*2 + (150 + 252)*2) / 6 = 177.333333
    #   Result (reduction=SUM_OVER_BATCH_SIZE/AUTO/NONE) = 532 / 6 = 88.66667

    # Loss `output_2`:
    #   Per-sample weighted losses
    #   Batch 1 = [(3 - 1)^2 * 3.5, (6 - 2)^2 * 2.5)] = [14, 40]
    #   Batch 2 = [(9 - 3)^2 * 1.5, (12 - 4)^2 * 0.5)] = [54, 32]
    #   Batch 3 = [(15 - 5)^2 * 3, (18 - 6)^2 * 2] = [300, 288]

    #   Result (reduction=SUM) =
    #       ((14 + 40)*2 + (54 + 32)*2 + (300 + 288)) / 6 = 144.666667
    #   Result (reduction=SUM_OVER_BATCH_SIZE/AUTO/NONE) = 728 / 6 = 121.3333
    ...
    sum_over_batch_size_fit_result = {
        'loss': [210, 210],
        'output_1_loss': [88.666664, 88.666664],
        'output_2_loss': [121.333336, 121.333336],
    }
    ...
    # 2 + 12 + 36 + 80 + 150 + 252 = 532
    # 14 + 40 + 54 + 32 + 300 + 288 = 440
    self.expected_single_batch_result = [1260, 532, 728]
